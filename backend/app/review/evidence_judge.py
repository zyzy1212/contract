...
_JUDGE_SYSTEM_PROMPT = (
    ...
    "判断候选证据能否支撑对合同条款的风险审核；证据不足时给出缺失要点和下一轮检索词。\n"
    "审核目标是条款本身是否合法、完整、可执行，不是核对当事人资质材料是否齐全。\n"
    "若证据能证明“条款缺少法律要求的内容”或“条款与法律规定不一致”，应判定为充分。\n"
    "常见风险维度包括：联合体共同投标协议与连带责任、合同成立与生效、履行期限与顺延、\n"
    "违约责任与违约金、不可抗力通知与免责、付款与价款、争议解决、质量标准。\n"
